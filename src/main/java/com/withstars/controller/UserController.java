...
public class UserController {
    ...
    public String autoAddUser(HttpServletRequest request,HttpSession session){
        //处理参数
     ...
     */
    @ResponseBody
    @RequestMapping("/user/getTopicCount")
    public int getUserTopicCount(HttpSession session) {
        //获取用户信息
        Integer uid=(Integer) session.getAttribute("userId");
        return topicService.getUserTopicsNum(uid);
    }
    /**
     * 获取用户积分
     */
    @ResponseBody
    @RequestMapping("/user/getScore")
    public int getUserScore(HttpSession session) {
        //获取用户信息
        Integer uid=(Integer) session.getAttribute("userId");
